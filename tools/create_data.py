...
from data_converter import jrdb_converter as jrdb_converter
...
def jrdb_data_prep(root_path, info_prefix, out_dir, dataset_name="JRDBDataset"):
    jrdb_converter.create_jrdb_infos(root_path, info_prefix=info_prefix, calib=False)
...
if __name__ == "__main__":
    ...
    if args.dataset == "nuscenes" and args.version != "v1.0-mini":
        ...
        jrdb_data_prep(root_path=args.root_path,
                       info_prefix=args.extra_tag,
                       dataset_name="JRDBDataset",
                       out_dir=args.out_dir,
                       )
